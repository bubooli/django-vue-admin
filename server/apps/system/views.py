...
class PTaskViewSet(OptimizationMixin, ModelViewSet):
    perms_map = {'get': 'ptask_manage', 'post': 'ptask_create',
...
class DictTypeViewSet(ModelViewSet):
    ...
    数据字典类型-增删改查
    """
    perms_map = {'get': 'dicttype_manage', 'post': 'dicttype_create',
...
class DictViewSet(ModelViewSet):
    ...
    数据字典-增删改查
    """
    perms_map = {'get': 'dict_manage', 'post': 'dict_create',
...
class PositionViewSet(ModelViewSet):
    ...
    岗位-增删改查
    """
    perms_map = {'get': 'position_manage', 'post': 'position_create',
...
class PermissionViewSet(ModelViewSet):
    ...
    权限-增删改查
    """
    perms_map = {'get': 'perm_manage', 'post': 'perm_create',
...
class OrganizationViewSet(ModelViewSet):
    ...
    组织机构-增删改查
    """
    perms_map = {'get': 'org_manage', 'post': 'org_create',
...
class RoleViewSet(ModelViewSet):
    ...
    角色-增删改查
    """
    perms_map = {'get': 'role_manage', 'post': 'role_create',
...
class UserViewSet(ModelViewSet):
    ...
    用户管理-增删改查
    """
    perms_map = {'get': 'user_manage', 'post': 'user_create',
    ...
    def password(self, request, pk=None):
        ...
        # 进行密码检查，参数1 旧密码，参数2 新密码，只有输入正确的旧密码后，才能设置新密码
    ...
    @action(methods=['get'], detail=False, url_path='info', url_name='my_info', permission_classes=[IsAuthenticated])
    def info(self, request, pk=None):
        ...
        data = {
            ...
            'avatar': request._request._current_scheme_host + str(user.avatar),
            # 'avatar': user.avatar,
            'perms': perms,
        }
